...
def reward_trainer(preference_data, sft_model, output_dir):
    dataset = load_dataset('json', data_files=preference_data)
...
if __name__ == "__main__":
    preference_data_json = "preference_data.json"
    sft_model = "PranavBP525/phi-2-finetuned-1k_stories_100_genre"
    output_dir = "./reward_model_outputs"
    reward_trainer(preference_data_json, sft_model, output_dir)
